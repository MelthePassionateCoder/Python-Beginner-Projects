...
$code= preg_replace('#[^A-Za-z0-9]#i','',$_SESSION["code"]);

include "../scripts/connectmysql.php";
$con = OpenCon();
$sql = mysqli_query($con,"SELECT * FROM phdoer_doer.coadmin WHERE coadmin_id='$managerID' AND coadmin_username='$manager' AND coadmin_password='$password' AND coadmin_code='$code' LIMIT 1");

    ...
    <div id="wrapper">
        <?php include_once("layout_head.php"); ?><div id="page-wrapper">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
              ...
              <tbody>
			  <?php
$sql = mysqli_query($con,"SELECT * FROM phdoer_doer.coadmin");
		...
		while($row=mysqli_fetch_array($sql))
		{
			...
			?>
                <tr>
                 ...
                 <td><?php echo $row['coadmin_username']; ?></td>
				 <td><?php echo $row['coadmin_name']; ?></td>
				 <td><?php echo $row['coadmin_contactnum']; ?></td>
				 <td><?php echo $row['coadmin_address']; ?></td>
				 <td><?php echo $row['coadmin_email']; ?></td>
				<td>
				
				 
				
				 <a class="btn btn-success" href="editcoadmin.php?pid=<?php echo $row['coadmin_id']; ?>"> Change Code</a> <a class="btn btn-danger" href="?delete_id=<?php echo $row['coadmin_id']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this customer?')">
